...
ADD COLUMN post_times time[] DEFAULT NULL,
ADD COLUMN multi_time_enabled boolean DEFAULT false;
...
BEGIN
  ...
  local_now := current_time AT TIME ZONE timezone_name;
  ...
  -- 次回実行時刻を構築
  next_run := (current_date + next_slot) AT TIME ZONE timezone_name;
