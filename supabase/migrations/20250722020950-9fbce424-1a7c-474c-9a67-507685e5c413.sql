...
-- Delete existing cron jobs to avoid duplicates
SELECT cron.unschedule('check-replies-every-minute');
SELECT cron.unschedule('process-scheduled-replies-every-minute');
