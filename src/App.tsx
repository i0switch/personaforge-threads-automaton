...
import AutoGeneratedContent from "@/pages/AutoGeneratedContent";
import RateLimitTest from "@/pages/RateLimitTest";
import ManualPost from "@/pages/ManualPost";
import ThreadsOAuthCallback from "@/pages/ThreadsOAuthCallback";
          ...
          <main className="flex-1 overflow-auto">
            <ErrorBoundary>
                  <Routes>
                    ...
                    <Route path="/auth/callback" element={<ThreadsOAuthCallback />} />
                    <Route
                      path="/"
                      element={
                        <ProtectedRoute>
